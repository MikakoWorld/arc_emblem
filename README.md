...
- `base.svg`の単色カラー変更
- `about.html`でアイギス・アークとzetaの概要、プロットリンクを紹介
...
- シャドウとフチ線はSVG内に含め、プレビュー、PNG保存、SVG保存で見た目が揃うようにしています。
- PNG書き出しでは、完成版SVGをCanvasへ描画します。
- SVG書き出しでは、土台サイズ、背景、余白、効果、カスタム済みエンブレムを含む完成版SVGを書き出します。
